                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-warning" onclick="redirectToCorrectPage()">SpellCheck</button></td>
                            ...
                            <td><button class="btn btn-warning" onclick="showPopup('Correctaed')">SpellCheck</button></td>
                            ...
                            <td><button class="btn btn-warning" onclick="showPopup('Corrected')">SpellCheck</button></td>
